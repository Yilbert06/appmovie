...
export const getActorsThunk = () => (dispatch) => {
    dispatch(genericRequestThunk(async () => {
        const res = await axios.get('https://movie-app-pxjy.onrender.com/api/v1/actors')
...
export const addActorThunk = actor => dispatch => {
    dispatch(genericRequestThunk(async () => {
        const res = await axios.post('https://movie-app-pxjy.onrender.com/api/v1/actors', actor);
...
export const deleteActorThunk = id => dispatch => {
    dispatch(genericRequestThunk(async () => {
        await axios.delete(`https://movie-app-pxjy.onrender.com/api/v1/actors/${id}`)
...
export const updateActorThunk = (id, actorParams) => dispatch => {
    dispatch(genericRequestThunk(async () => {
        const {data: actor} = await axios.put(`https://movie-app-pxjy.onrender.com/api/v1/actors/${id}`, actorParams)
